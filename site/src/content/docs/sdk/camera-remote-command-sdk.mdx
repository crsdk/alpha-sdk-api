...
<LinkCard title="Camera Remote Command SDK" href="https://support.d-imaging.sony.co.jp/app/cameraremotecommand/en/index.html" description="Download from Sony's developer portal" />

## Related Resources

<CardGrid>
<LinkCard title="Camera Remote SDK" href="/alpha-sdk-api/sdk/camera-remote-sdk/" description="Sony's higher-level native SDK — recommended for most projects" />
  <LinkCard title="CameraRemoteSDK MCP Server" href="/alpha-sdk-api/mcp-server/overview/" description="Search SDK documentation with AI-powered natural language queries" />
</CardGrid>
