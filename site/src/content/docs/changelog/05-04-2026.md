...
- **Public example apps** — the docs now point at the live reference repos:
  - [`alpha-sdk-typescript`](https://github.com/crsdk/alpha-sdk-typescript)
  - [`alpha-sdk-python`](https://github.com/crsdk/alpha-sdk-python)
  - [`alpha-sdk-swift`](https://github.com/crsdk/alpha-sdk-swift) (now also includes the macOS sample app)
