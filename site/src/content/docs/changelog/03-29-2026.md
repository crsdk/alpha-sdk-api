...
### New
- **`CameraRemoteSDK` for Swift / iOS** — hand-written Swift client targeting iOS 26. Mirrors the TypeScript `BoundCamera` API surface, with native SSE and `async/await` on every endpoint. Available via Swift Package Manager; see the [Swift SDK reference](/alpha-sdk-api/sdk/swift/).
