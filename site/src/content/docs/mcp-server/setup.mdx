...
<LinkCard title="Overview" href="/alpha-sdk-api/mcp-server/overview/" description="New to the MCP servers? Start with the overview." />
...
4. **Configure System Prompt (Optional but Recommended)**
   ...
   A system prompt significantly improves performance. See the [System Prompt](/alpha-sdk-api/mcp-server/system-prompt/) page for setup instructions.
...
<TabItem label="Windows (PowerShell or CMD)">
...
:::tip
For system prompt setup, see the [System Prompt](/alpha-sdk-api/mcp-server/system-prompt/) page.
:::
