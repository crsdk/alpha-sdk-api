...
<LinkCard title="Setup Guide" href="/alpha-sdk-api/mcp-server/setup/" description="Step-by-step instructions for connecting AI SDK Assistant to your chosen platform" />
