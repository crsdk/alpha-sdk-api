...
If you'd rather call typed methods than build URLs by hand, three [language clients](/alpha-sdk-api/sdk/overview/) wrap this API:

- **TypeScript / Node** — [`@alpha-sdk/client`](/alpha-sdk-api/sdk/typescript/)
- **Python** — [`alpha-sdk-client`](/alpha-sdk-api/sdk/python/)
- **Swift (iOS / macOS)** — [`AlphaSDK`](/alpha-sdk-api/sdk/swift/)

To run the server itself: `npm install -g @alpha-sdk/api && camera-server start`. Or embed it in your Node app via the [`ServerManager`](/alpha-sdk-api/web-api/server/) class.
