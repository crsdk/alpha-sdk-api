...
:::note
For typed action helpers, use the SDK pages: [TypeScript](/alpha-sdk-api/sdk/overview/), [Python](/alpha-sdk-api/sdk/overview/), or [Swift](/alpha-sdk-api/sdk/overview/).
:::
