...
`POST /api/cameras/{cameraId}/connection` — establish a connection in the specified [mode](/alpha-sdk-api/web-api/overview/#connection-modes).
...
:::note
For typed client calls, [generate a client](/alpha-sdk-api/sdk/overview/) from the OpenAPI specification.
:::
