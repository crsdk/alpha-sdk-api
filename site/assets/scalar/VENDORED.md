...
Both live in `site/api-reference/index.html`. Re-check them after any upgrade,
...
cp package/dist/browser/standalone.js site/assets/scalar/standalone.js
shasum -a 256 site/assets/scalar/standalone.js   # update the table above
```
