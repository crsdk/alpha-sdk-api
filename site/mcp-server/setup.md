...
- [**Overview**]({{ site.baseurl }}/mcp-server/overview) — New to the MCP servers? Start with the overview.
...
4. **Configure System Prompt (Optional but Recommended)**
   ...
   A system prompt significantly improves performance. See the [System Prompt]({{ site.baseurl }}/mcp-server/system-prompt) page for setup instructions.
...
{: .tip }
> For system prompt setup, see the [System Prompt]({{ site.baseurl }}/mcp-server/system-prompt) page.
